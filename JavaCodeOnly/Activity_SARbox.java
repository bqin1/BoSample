...
/**
 * This activity displays the top button bar and houses the fragments container
 *
 * @author Bo Qin
 * @version 3.4
 * @since 2014-11-07
 */
//TODO: buttons should detect clicks only on the circle button parts
public class Activity_SARbox extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String toastMsg = getResources().getString(R.string.toastmessage_nontablet);
        switch (screenSize) {
    ...
    /**
     * When click a button, highlight the background.
     * This is implemented simply through changing image icon
     */
    public void changeButtonBackground(Button b, int image) {

		/*
        * TODO:
	    * this is inefficient, a better way to do this is to remember the
    ...
    /**
     * opens the clicked fragment in the fragment container
     */
